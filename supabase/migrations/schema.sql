...
-- =============================================================================
-- INDEXES  (Postgres does NOT auto-create indexes on FK columns)
-- =============================================================================
...
BEGIN
  IF TG_OP = 'INSERT' THEN
    -- Decrement stock; CHECK constraint on products will reject if stock < 0
    UPDATE public.products
       SET stock = stock - NEW.quantity
     WHERE id = NEW.product_id;

  ELSIF TG_OP = 'DELETE' THEN
    -- Restore stock on return / removal
  ...
  ELSIF TG_OP = 'UPDATE' THEN
    -- Handle product swap and/or quantity change
...
DECLARE
  v_cart_id UUID;
BEGIN
  -- Determine which cart needs recalculation
...
-- Authenticated policy: covers normal post-signup inserts
